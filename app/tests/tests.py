...
asyncio.run(model_loading_test(query_for_fandq=None, query_for_policy="My age is 22 i am married and one kid who is 5 years old.Can you please provide me with some good policies?"))
